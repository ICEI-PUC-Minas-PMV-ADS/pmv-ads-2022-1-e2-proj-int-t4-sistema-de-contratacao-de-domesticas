...
namespace Limpou_Faxinas.Controllers
{
    public class ServicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ServicoId,tipo_de_servico,Descricao,Preco")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServicoId,tipo_de_servico,Descricao,Preco")] Servico servico)
        {
